                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tb_left pull-left">
                                <p>Welcome to our naqsh store !</p>
                            </div>
                            <div class="tb_center pull-left">
                                <ul>
                                    <li><i class="fa fa-phone"></i> Hotline: <a href="#">(+91) 9477895396</a></li>
                                    <li><i class="fa fa-envelope-o"></i> <a href="#">support@naqsh.in</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="header-xtra pull-right">
                            <div class="topcart">
                                ...
                                <div class="cart-info">
                                    <small>You have <em class="highlight"> item(s)</em> in your shopping bag</small>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="contact.php" class="dropdown-toggle" data-toggle="dropdown" role="button"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <!-- HTML -->
                        <div id="account-id">
                            <h4 class="account-title"><span class="fa fa-chevron-right"></span>Sign In</h4>
                            <div class="account-form">
                                <form class="form-login">
                                    <ul class="form-list row">
                                    ...
                                    <div class="buttons-set">
                                        <button class="btn-black" type="submit"><span>Sign in</span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
